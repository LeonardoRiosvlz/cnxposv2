...
type Props = {
	row: PreparationType | null | undefined

}
const PreparationTypeDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('PreparationTypeconstantCase__INFO')}</h3>
...
export default PreparationTypeDetails;
