...
type Props = {
	row: ProductArea | null | undefined

}
const ProductAreaDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('ProductAreaconstantCase__INFO')}</h3>
...
export default ProductAreaDetails;
