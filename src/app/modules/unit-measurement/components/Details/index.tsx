...
type Props = {
	row: UnitMeasurement | null | undefined

}
const UnitMeasurementDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('UnitMeasurementconstantCase__INFO')}</h3>
...
export default UnitMeasurementDetails;
