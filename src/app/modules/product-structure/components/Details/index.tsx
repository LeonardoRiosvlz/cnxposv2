...
type Props = {
	row: ProductStructure | null | undefined

}
const ProductStructureDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('ProductStructureconstantCase__INFO')}</h3>
...
export default ProductStructureDetails;
