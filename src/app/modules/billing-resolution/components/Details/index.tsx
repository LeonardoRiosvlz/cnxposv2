...
type Props = {
	row: BillingResolution | null | undefined

}
const BillingResolutionDetails: React.FC<Props> = ({ row }: Props) => {
	...
	return (<div className='w-full flex flex-col'>
		...
		<h3 className='mt-2'>{t('BillingResolutionconstantCase__INFO')}</h3>
...
export default BillingResolutionDetails;
